...
hx + hx
"""
# Сделано очень коряво, мне не нравится. Но времени не было нормально оптимизирвоать все это ;)
...
print(f'Сумма чисел равна: {list(summ[2:])}')
print(f'Произведение чисел: {list(mult[2:])}')
